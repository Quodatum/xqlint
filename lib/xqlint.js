...
const mods = require('./module-library.json');
...
var createStaticContext = exports.createStaticContext = function (processor) {
    ...
    //@TODO this is better, is this best? NO!
    //sctx.setModulesFromXQDoc(mods);
    return sctx;
};
...
exports.XQLint = function (source, opts) {
    const defaults = { styleCheck: false ,processor: 'basex'};
    ...
    this.getNode = function (pos) {
        return completer.node(source, ast, sctx, pos);
    };
