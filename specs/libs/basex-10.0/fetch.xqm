...
(:~ 
 ...
 :
 : @param  fetch:binary($href value of type xs:string
...
(:~ 
 ...
 :
 : @param  fetch:text($href value of type xs:string
...
(:~ 
 ...
 :
 : @param  fetch:doc($href value of type xs:string
...
(:~ 
 ...
 :
 : @param  fetch:binary-doc($input value of type xs:anyAtomicType
 : @return value of type document-node() 
...
(:~ 
 ...
 :
 : @param  fetch:content-type($href value of type xs:string
 : @return value of type xs:string 
 : @error fetch:open the URI could not be resolved, or the resource could not be retrieved.
 :)
