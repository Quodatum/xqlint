...
(:~ 
 ...
 :
 : @param  xquery:eval($query value of type xs:anyAtomicType
...
(:~ 
 ...
 :
 : @param  xquery:eval-update($query value of type xs:anyAtomicType
 : @return value of type item()* 
...
(:~ 
 ...
 :
 : @param  xquery:parse($query value of type xs:anyAtomicType
 : @return value of type item()? 
 :)
...
(:~ 
 ...
 :
 : @param  xquery:fork-join($functions value of type function(*)*
 : @return value of type item()* 
