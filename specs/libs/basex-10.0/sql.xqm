...
(:~ 
 ...
 :
 : @param  sql:init($class value of type xs:string
...
(:~ 
 ...
 :
 : @param  sql:connect($url value of type xs:string
...
(:~ 
 ...
 :
 : @param  sql:execute($id value of type xs:anyURI
...
(:~ 
 ...
 :
 : @param  sql:execute-prepared($id value of type xs:anyURI
...
(:~ 
 ...
 :
 : @param  sql:prepare($id value of type xs:anyURI
 : @param $statement value of type xs:string
 : @return value of type xs:anyURI 
 : @error sql:error an error occurred while executing SQL.
 : @error sql:id the specified connection does not exist.
...
(:~ 
 ...
 :
 : @param  sql:commit($id value of type xs:anyURI
 : @return value of type empty-sequence() 
 : @error sql:error an error occurred while executing SQL.
 : @error sql:id the specified connection does not exist.
 :)
...
(:~ 
 ...
 :
 : @param  sql:rollback($id value of type xs:anyURI
 : @return value of type empty-sequence() 
 : @error sql:error an error occurred while executing SQL.
 : @error sql:id the specified connection does not exist.
 :)
...
(:~ 
 ...
 :
 : @param  sql:close($id value of type xs:anyURI
 : @return value of type empty-sequence() 
 : @error sql:error an error occurred while executing SQL.
 : @error sql:id the specified connection does not exist.
 :)
