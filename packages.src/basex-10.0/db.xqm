...
(:~ 
 : Returns meta information on the database <code>$db</code>. The output is similar to the <code> <a href="https://docs.basex.org/wiki/Commands#INFO_DB">INFO DB</a> </code> command.
 :
...
(:~ 
 : Returns the value (string, boolean, integer) of a property with the specified <code>$name</code> in the database <code>$db</code>. The available properties are the ones returned by <code> <a href="https://docs.basex.org/wiki/Database_Module#db:info">db:info</a> </code>.
 :
 : @param $db value of type xs:string
 : @param $name value of type xs:string
...
(:~ 
 : Returns all documents from the database <code>$db</code>, or only documents matching the specified <code>$path</code>.
 :
 : @param $db value of type xs:string
 : @return value of type document-node()*
 : @error db:open the addressed database does not exist or could not be opened.
 :)
declare function db:get($db as xs:string) as document-node()* external;
...
(:~ 
 ...
 :)
declare function db:get-id($db as xs:string, $ids as xs:integer*) as node()* external;

(:~ 
 : Returns a map with all paths and binary resources of the database <code>$db</code>. A single <code>xs:base64Binary</code> item is returned if a <code>$path</code> is specified. All items are <a href="https://docs.basex.org/wiki/Lazy_Module">lazy</a>, i.e., the actual data will only be retrieved if it is processed.
 :
 : @param $db value of type xs:string
 : @param $path value of type xs:string
 ...
 :)
declare function db:get-binary($db as xs:string, $path as xs:string) as item() external;

(:~ 
 : Returns a map with all paths and values of the database <code>$db</code>. A single value is returned if a <code>$path</code> is specified.
 :
 : @param $db value of type xs:string
 : @param $path value of type xs:string
 : @return value of type item()*
 ...
 : @error db:mainmem the database is not <i>persistent</i> (stored on disk).
 :)
declare function db:get-value($db as xs:string, $path as xs:string) as item()* external;

(:~ 
 : Returns the <i>pre</i> values of the specified <code>$nodes</code>, which must all be <a href="https://docs.basex.org/wiki/Database_Module#Database_Nodes">database nodes</a>.<br/>The <a href="https://docs.basex.org/wiki/Node_Storage#PRE_Value">PRE value</a> provides very fast access to an existing database node, but it will change whenever a node with a smaller <i>pre</i> values is added to or deleted from a database.
 :
...
(:~ 
 : Returns the <i>id</i> values of the specified <code>$nodes</code>, which must all be <a href="https://docs.basex.org/wiki/Database_Module#Database_Nodes">database nodes</a>.<br/>Each database node has a <i>persistent</i> <a href="https://docs.basex.org/wiki/Node_Storage#ID_Value">ID value</a>. Access to the node id can be sped up by turning on the <code> <a href="https://docs.basex.org/wiki/Options#UPDINDEX">UPDINDEX</a> </code> option.
 :
 : @param $nodes value of type node()*
 : @return value of type xs:integer*
 : @error db:node <code>$nodes</code> contains a node which is not stored in a database.
...
(:~ 
 ...
 :)
declare function db:put($db as xs:string, $input as item(), $path as xs:string) as empty-sequence() external;
...
(:~ 
 ...
 : @error db:target the path points to a directory.
 :)
declare function db:put($db as xs:string, $input as item(), $path as xs:string, $options as map(*)?) as empty-sequence() external;

(:~ 
 : Stores a binary resource specified by <code>$input</code> in the database <code>$db</code> at the specified <code>$path</code>. Existing resources are overwritten.
 :
 : @param $db value of type xs:string
 : @param $input value of type item()
 : @param $path value of type xs:string
 ...
 : @error db:mainmem the database is not <i>persistent</i> (stored on disk).
 :)
declare function db:put-binary($db as xs:string, $input as item(), $path as xs:string) as empty-sequence() external;

(:~ 
 : Stores a value specified by <code>$input</code> in the database <code>$db</code> at the specified <code>$path</code>. Existing resources are overwritten. The value can be an arbitrary sequence of atomic items, nodes, maps, and arrays.
 :
 : @param $db value of type xs:string
 : @param $input value of type item()*
 : @param $path value of type xs:string
 ...
 : @error db:mainmem the database is not <i>persistent</i> (stored on disk).
 :)
declare function db:put-value($db as xs:string, $input as item()*, $path as xs:string) as empty-sequence() external;
...
(:~ 
 : Explicitly flushes the buffers of the database <code>$db</code>. This command is only useful if <code> <a href="https://docs.basex.org/wiki/Options#AUTOFLUSH">AUTOFLUSH</a> </code> has been set to <code>false</code>.
 :
 : @param $db value of type xs:string
 : @error db:open the addressed database does not exist or could not be opened.
 :)
...
(:~ 
 : Returns the type of a resource – <code>xml</code>, <code>binary</code>, or <code>value</code> – in the database <code>$db</code> at the specified <code>$path</code>.
 :
 : @param $db value of type xs:string
 : @param $path value of type xs:string
 : @return value of type xs:boolean
 : @error db:open the addressed database does not exist or could not be opened.
 :)
declare function db:type($db as xs:string, $path as xs:string) as xs:boolean external;
