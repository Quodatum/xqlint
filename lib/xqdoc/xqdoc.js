...
exports.XQDoc = function (ast, sctx) {
    ...
    this.VarDecl = function (node) {
        ...
        symbols.push({ key: key, type: "VarDecl", pos: node.getParent.pos });
    ...
    this.FunctionDecl = function (node) {
        ...
        symbols.push({ key: key, type: "FunctionDecl", pos: node.getParent.pos }); // save range of enclosing declaration
