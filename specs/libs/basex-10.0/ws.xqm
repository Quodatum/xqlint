...
(:~ 
 ...
 :
 : @param  ws:path($id value of type xs:string
 : @return value of type xs:string 
 : @error ws:not-found No WebSocket with the specified id exists.
 :)
...
(:~ 
 ...
 :
 : @param  ws:close($id value of type xs:string
...
(:~ 
 ...
 :
 : @param  ws:send($message value of type item()
...
(:~ 
 ...
 :
 : @param  ws:broadcast($message value of type xs:anyAtomicType
 : @return value of type empty-sequence() 
 :)
...
(:~ 
 ...
 :
 : @param  ws:emit($message value of type xs:anyAtomicType
 : @return value of type empty-sequence() 
 :)
...
(:~ 
 ...
 :
 : @param  ws:eval($query value of type xs:anyAtomicType
 : @return value of type xs:string 
...
(:~ 
 ...
 :
 : @param  ws:get($id value of type xs:string
...
(:~ 
 ...
 :
 : @param  ws:set($id value of type xs:string
 : @param $name value of type xs:string
...
(:~ 
 ...
 :
 : @param  ws:delete($id value of type xs:string
 : @param $name value of type xs:string
 : @return value of type empty-sequence() 
 : @error ws:not-found No WebSocket with the specified id exists.
 :)
