...
(:~ 
 : Computes the <a href="https://web.archive.org/web/20220623232539/https://en.wikipedia.org/wiki/Soundex">Soundex</a> value for the specified string. The algorithm can be used to find and index English words with similar pronouncation.
 :
