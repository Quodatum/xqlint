...
(:~ 
 ...
 :)
declare function crypto:hmac($message as xs:string, $key as xs:anyAtomicType) as xs:base64Binary, $algorithm as xs:string external;
...
(:~ 
 ...
 : @error experr:CX0019 the specified secret key is invalid.
 :)
declare function crypto:hmac($message as xs:string, $key as xs:anyAtomicType) as xs:base64Binary, $algorithm as xs:string, $encoding as xs:string external;
