...
(:~ 
 ...
 :
 : @param  map:contains($map value of type map(*)
...
(:~ 
 ...
 :
 : @param  map:entry($key value of type xs:anyAtomicType
...
(:~ 
 ...
 :
 : @param  map:find($input value of type item()*
 : @param $key value of type xs:anyAtomicType
...
(:~ 
 ...
 :
 : @param  map:for-each($map value of type map(*)
...
(:~ 
 ...
 :
 : @param  map:get($map value of type map(*)
 : @param $key value of type xs:anyAtomicType
 : @return value of type item()* 
 :)
...
(:~ 
 ...
 :
 : @param  map:keys($map value of type map(*)
...
(:~ 
 ...
 :
 : @param  map:merge($maps value of type map(*)*
 : @return value of type map(*) 
 :)
...
(:~ 
 ...
 :
 : @param  map:put($map value of type map(*)
 : @param $key value of type xs:anyAtomicType
 : @param $value value of type item()*
 : @return value of type map(*) 
 :)
...
(:~ 
 ...
 :
 : @param  map:remove($map value of type map(*)
...
(:~ 
 ...
 :
 : @param  map:size($map value of type map(*)
