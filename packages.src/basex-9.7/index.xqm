(:~ 
 : This <a href="https://web.archive.org/web/20220623230943/https://docs.basex.org/web/20220623231030/https://docs.basex.org/wiki/Module_Library">XQuery Module</a> provides functions for displaying information stored in the database index structures.
 :
 : @author BaseX Team
 : @see https://web.archive.org/web/20220623231014/https://docs.basex.org/wiki/Index_Module
 :)
module namespace index = "http://basex.org/modules/index";

(:~ 
 : Returns information about all facets and facet values of the database <code>$db</code> in document structure format.<br/>If <code>$type</code> is specified as <code>flat</code>, the function returns this information in a flat summarized version. The returned data is derived from the <a href="https://web.archive.org/web/20220623230943/https://docs.basex.org/web/20220623231030/https://docs.basex.org/wiki/Indexes#Path_Index">Path Index</a>.
 :
...
(:~ 
 : Returns all strings stored in the <a href="https://web.archive.org/web/20220623230943/https://docs.basex.org/web/20220623231030/https://docs.basex.org/wiki/Indexes#Token_Index">Token Index</a> of the database <code>$db</code>, along with their number of occurrences.
 :
 : @param $db value of type xs:string
 : @return value of type element(value)*
 : @error db:open The addressed database does not exist or could not be opened.
...
(:~ 
 : Returns all element names stored in the <a href="https://web.archive.org/web/20220623230943/https://docs.basex.org/web/20220623231030/https://docs.basex.org/wiki/Indexes#Name_Index">Name Index</a> of the database <code>$db</code>, along with their number of occurrences.
 :
 : @param $db value of type xs:string
 : @return value of type element(value)*
 : @error db:open The addressed database does not exist or could not be opened.
...
(:~ 
 : Returns all attribute names stored in the <a href="https://web.archive.org/web/20220623230943/https://docs.basex.org/web/20220623231030/https://docs.basex.org/wiki/Indexes#Name_Index">Name Index</a> of the database <code>$db</code>, along with their number of occurrences.
 :
 : @param $db value of type xs:string
 : @return value of type element(value)*
 : @error db:open The addressed database does not exist or could not be opened.
