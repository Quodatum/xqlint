...
(:~ 
 ...
 :
 : @param  client:connect($host value of type xs:string
...
(:~ 
 ...
 :
 : @param  client:execute($id value of type xs:anyURI
...
(:~ 
 ...
 :
 : @param  client:info($id value of type xs:anyURI
 : @return value of type xs:string 
 :)
...
(:~ 
 ...
 :
 : @param  client:query($id value of type xs:anyURI
...
(:~ 
 ...
 :
 : @param  client:close($id value of type xs:anyURI
