...
(:~ 
 : Retrieves and installs a package from the given <code>$uri</code>. Existing packages are replaced.
 :
 ...
 :)
declare function repo:install($uri as xs:string) as empty-sequence() external;
