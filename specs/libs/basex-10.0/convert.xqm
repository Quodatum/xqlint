...
(:~ 
 ...
 :
 : @param  convert:binary-to-string($bytes value of type xs:anyAtomicType
...
(:~ 
 ...
 :
 : @param  convert:string-to-base64($string value of type xs:string
...
(:~ 
 ...
 :
 : @param  convert:string-to-hex($string value of type xs:string
...
(:~ 
 ...
 :
 : @param  convert:integers-to-base64($integers value of type xs:integer*
 : @return value of type xs:base64Binary 
 :)
...
(:~ 
 ...
 :
 : @param  convert:integers-to-hex($integers value of type xs:integer*
 : @return value of type xs:hexBinary 
 :)
...
(:~ 
 ...
 :
 : @param  convert:binary-to-integers($binary value of type xs:anyAtomicType
...
(:~ 
 ...
 :
 : @param  convert:binary-to-bytes($binary value of type xs:anyAtomicType
...
(:~ 
 ...
 :
 : @param  convert:integer-to-base($number value of type xs:integer
...
(:~ 
 ...
 :
 : @param  convert:integer-from-base($string value of type xs:string
 : @param $base value of type xs:integer
 : @return value of type xs:integer 
 : @error convert:base The specified base is not in the range 2-36.
...
(:~ 
 ...
 :
 : @param  convert:integer-to-dateTime($milliseconds value of type xs:integer
...
(:~ 
 ...
 :
 : @param  convert:dateTime-to-integer($dateTime value of type xs:dateTime
 : @return value of type xs:integer 
 :)
...
(:~ 
 ...
 :
 : @param  convert:integer-to-dayTime($milliseconds value of type xs:integer
...
(:~ 
 ...
 :
 : @param  convert:dayTime-to-integer($dayTime value of type xs:dayTimeDuration
 : @return value of type xs:integer 
 :)
...
(:~ 
 ...
 :
 : @param  convert:encode-key($key value of type xs:string
 : @return value of type xs:string 
 :)
...
(:~ 
 ...
 :
 : @param  convert:decode-key($key value of type xs:string
 : @return value of type xs:string 
