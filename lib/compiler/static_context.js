exports.StaticContext = function (parent, pos) {
    ...
    if(!parent) {
        ...
        namespaces['http://basex.org/modules/hash'] = {
            prefixes: ['hash'],
            pos: emptyPos,
            type: 'module',
            override: true
        ...
        namespaces['http://basex.org/modules/inspect'] = {
            prefixes: ['inspect'],
            pos: emptyPos,
            type: 'module',
            override: true
        };
        namespaces['http://basex.org/modules/jobs'] = {
            prefixes: ['jobs'],
            pos: emptyPos,
            type: 'module',
            override: true
        };
        namespaces['http://basex.org/modules/validate'] = {
            prefixes: ['validate'],
            pos: emptyPos,
            type: 'module',
            override: true
        ...
        namespaces['http://www.w3.org/2005/xpath-functions/map'] = {
            prefixes: ['map'],
            pos: emptyPos,
            type: 'module',
            override: true
