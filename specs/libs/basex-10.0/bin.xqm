...
(:~ 
 ...
 :
 : @param  bin:hex($in value of type xs:string?
...
(:~ 
 ...
 :
 : @param  bin:bin($in value of type xs:string?
 : @return value of type xs:base64Binary? 
...
(:~ 
 ...
 :
 : @param  bin:octal($in value of type xs:string?
 : @return value of type xs:base64Binary? 
...
(:~ 
 ...
 :
 : @param  bin:to-octets($in value of type xs:base64Binary
...
(:~ 
 ...
 :
 : @param  bin:from-octets($in value of type xs:integer*
 : @return value of type xs:base64Binary 
...
(:~ 
 ...
 :
 : @param  bin:length($in value of type xs:base64Binary
 : @return value of type xs:integer 
 :)
...
(:~ 
 ...
 :
 : @param  bin:part($in value of type xs:base64Binary?
...
(:~ 
 ...
 :
 : @param  bin:join($in value of type xs:base64Binary*
 : @return value of type xs:base64Binary 
 :)
...
(:~ 
 ...
 :
 : @param  bin:insert-before($in value of type xs:base64Binary?
 : @param $offset value of type xs:integer
...
(:~ 
 ...
 :
 : @param  bin:pad-left($in value of type xs:base64Binary?
 : @param $size value of type xs:integer
 : @return value of type xs:base64Binary? 
 : @error bin:negative-size the specified size is negative.
...
(:~ 
 ...
 :
 : @param  bin:pad-right($in value of type xs:base64Binary?
 : @param $size value of type xs:integer
 : @return value of type xs:base64Binary? 
 : @error bin:negative-size the specified size is negative.
 : @error bin:octet-out-of-range the specified octet lies outside the range 0-255.
...
(:~ 
 ...
 :
 : @param  bin:find($in value of type xs:base64Binary?
 : @param $offset value of type xs:integer
...
(:~ 
 ...
 :
 : @param  bin:decode-string($in value of type xs:base64Binary?
...
(:~ 
 ...
 :
 : @param  bin:encode-string($in value of type xs:string?
 : @param $encoding value of type xs:string
 : @return value of type xs:base64Binary? 
 : @error bin:unknown-encoding the specified encoding is unknown.
...
(:~ 
 ...
 :
 : @param  bin:pack-double($in value of type xs:double
 : @return value of type xs:base64Binary 
...
(:~ 
 ...
 :
 : @param  bin:pack-float($in value of type xs:float
 : @return value of type xs:base64Binary 
 : @error bin:unknown-significance-order the specified octet order is unknown.
 :)
...
(:~ 
 ...
 :
 : @param  bin:pack-integer($in value of type xs:integer
 : @param $size value of type xs:integer
 : @return value of type xs:base64Binary 
 : @error bin:unknown-significance-order the specified octet order is unknown.
 : @error bin:negative-size the specified size is negative.
...
(:~ 
 ...
 :
 : @param  bin:unpack-double($in value of type xs:base64Binary
 : @param $offset value of type xs:integer
...
(:~ 
 ...
 :
 : @param  bin:unpack-float($in value of type xs:base64Binary
 : @param $offset value of type xs:integer
...
(:~ 
 ...
 :
 : @param  bin:unpack-integer($in value of type xs:base64Binary
 : @param $offset value of type xs:integer
 : @param $size value of type xs:integer
 : @return value of type xs:integer 
 : @error bin:negative-size the specified size is negative.
...
(:~ 
 ...
 :
 : @param  bin:unpack-unsigned-integer($in value of type xs:base64Binary
 : @param $offset value of type xs:integer
 : @param $size value of type xs:integer
 : @return value of type xs:integer 
 : @error bin:negative-size the specified size is negative.
...
(:~ 
 ...
 :
 : @param  bin:or($a value of type xs:base64Binary?
...
(:~ 
 ...
 :
 : @param  bin:xor($a value of type xs:base64Binary?
 : @param $b value of type xs:base64Binary?
 : @return value of type xs:base64Binary? 
 : @error bin:differing-length-arguments the input arguments are of differing length.
 :)
...
(:~ 
 ...
 :
 : @param  bin:and($a value of type xs:base64Binary?
 : @param $b value of type xs:base64Binary?
 : @return value of type xs:base64Binary? 
 : @error bin:differing-length-arguments the input arguments are of differing length.
 :)
...
(:~ 
 ...
 :
 : @param  bin:not($in value of type xs:base64Binary?
 : @return value of type xs:base64Binary? 
 :)
...
(:~ 
 ...
 :
 : @param  bin:shift($in value of type xs:base64Binary?
