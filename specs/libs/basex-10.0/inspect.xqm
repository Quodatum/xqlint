...
(:~ 
 ...
 :
 : @param  inspect:functions( value of type 
...
(:~ 
 : Returns function items for all user-defined functions (both public and private) that are known in the current query context. If an <code>$href</code> value is specified, the specified resource will be retrieved as a string and compiled, and its functions will be added to the query context and returned to the user. A relative URI will be resolved against the static base URI of the query.
 :
 : @param  inspect:functions($href value of type xs:string
 : @return value of type function(*)* 
 : @error inspect:parse Error while parsing a module.
 :)
...
(:~ 
 ...
 :
 : @param  inspect:function-annotations($function value of type function(*)
...
(:~ 
 ...
 :
 : @param  inspect:static-context($function value of type function(*)?
...
(:~ 
 ...
 :
 : @param  inspect:type($input value of type item()*
...
(:~ 
 ...
 :
 : @param  inspect:function($function value of type function(*)
...
(:~ 
 ...
 :
 : @param  inspect:context( value of type 
...
(:~ 
 ...
 :
 : @param  inspect:module($uri value of type xs:string
...
(:~ 
 ...
 :
 : @param  inspect:xqdoc($uri value of type xs:string
