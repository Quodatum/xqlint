...
(:~ 
 ...
 :
 : @param  archive:entries($archive value of type xs:base64Binary
...
(:~ 
 ...
 :
 : @param  archive:options($archive value of type xs:base64Binary
...
(:~ 
 ...
 :
 : @param  archive:extract-text($archive value of type xs:base64Binary
...
(:~ 
 ...
 :
 : @param  archive:extract-binary($archive value of type xs:base64Binary
...
(:~ 
 ...
 :
 : @param  archive:create($entries value of type item()
...
(:~ 
 ...
 :
 : @param  archive:update($archive value of type xs:base64Binary
 : @param $entries value of type item()*
 : @param $contents value of type item()*
 : @return value of type xs:base64Binary 
 : @error archive:number the number of entries and contents differs.
...
(:~ 
 ...
 :
 : @param  archive:delete($archive value of type xs:base64Binary
 : @param $entries value of type item()*
 : @return value of type xs:base64Binary 
 : @error archive:modify the entries of the given archive cannot be modified.
 : @error archive:error archive creation failed.
...
(:~ 
 ...
 :
 : @param  archive:create-from($path value of type xs:string
 : @return value of type xs:base64Binary 
...
(:~ 
 ...
 :
 : @param  archive:extract-to($path value of type xs:string
...
(:~ 
 ...
 :
 : @param  archive:write($path value of type xs:string
 : @param $entries value of type item()
 : @param $contents value of type item()*
 : @return value of type xs:base64Binary 
 : @error archive:number the number of entries and contents differs.
